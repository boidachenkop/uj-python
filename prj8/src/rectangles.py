...
# @Last Modified time: 2018-09-30 21:47:56
...
class Rectangle:
	...
	def p_inside(self, point):
		return (self.pt1.x <= point.x <= self.pt2.x) and (self.pt1.y <= point.y <= self.pt2.y)
...
class TestRectangle(unittest.TestCase): 
	...
	def test_p_inside(self):
		self.assertTrue(not self.rect2.p_inside(self.p1))
		self.assertTrue(self.rect2.p_inside(self.p2))
